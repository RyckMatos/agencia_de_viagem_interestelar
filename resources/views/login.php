...
<main>
    <div class="main-container" id="container">
        ...
        <div class="form-container log-in-container">
            <form action="/agencia-de-viagem-interestelar/database/VerificarUsuario.php" method="POST" class="form login">
                <h1>Login</h1>
                ...
                <span>Não é membro? <a href="/agencia-de-viagem-interestelar/resources/views/cadastro.php">Inscreva-se agora</a></span>
            </form>
        </div>
    </div>
</main>
