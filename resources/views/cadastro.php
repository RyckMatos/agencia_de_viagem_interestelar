    ...
    <div class="main-container" id="container">
        <div class="mask-foguete">
            <svg style="height: 90%;" class="z-0 mt-10 ml-5 absolute text-brand-lilac-dark transform" viewBox="0 0 988 889" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <img src="/agencia-de-viagem-interestelar/resources/img/foguete.png" alt="" />
            </svg>
        </div>
        <div class="form-container cadastro-container">
            <form action="/agencia-de-viagem-interestelar/database/InserirUsuario.php" method="POST" class="form cadastro">
                ...
                <span class="w-100">Já é membro? <a href="/agencia-de-viagem-interestelar/resources/views/login.php">Logar agora</a></span>
            </form>
        </div>
    </div>
</main>
